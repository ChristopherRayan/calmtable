...
export default function ManagerOrdersPage() {
  ...
  if (loading) return <div className="text-white/40">Loading orders...</div>;
        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="border-b border-white/5 bg-white/2">
              <th className="px-6 py-4 text-[10px] font-bold text-white/40 uppercase tracking-widest">Order #</th>
              ...
              <th className="px-6 py-4 text-[10px] font-bold text-white/40 uppercase tracking-widest">Chef</th>
            ...
            {orders.map((order) => (
              <tr key={order.id} className="group hover:bg-white/2 transition-colors">
                <td className="px-6 py-4">
                  <span className="text-xs font-bold text-amber-500">{order.order_number}</span>
                </td>
                <td className="px-6 py-4">
                ...
                <td className="px-6 py-4">
                  <select
                    className="bg-[#0a0604] border border-white/10 rounded-lg px-2 py-1 text-[10px] text-white/80 outline-none focus:border-amber-500/50"
